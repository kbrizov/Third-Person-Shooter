...
void ABaseCharacter::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	...
	if (CapsuleComponent)
	{
		CapsuleComponent->OnComponentBeginOverlap.RemoveDynamic(this, &ABaseCharacter::OnCoverVolumeBeginOverlap);
		CapsuleComponent->OnComponentEndOverlap.RemoveDynamic(this, &ABaseCharacter::OnCoverVolumeEndOverlap);
		CapsuleComponent->OnComponentBeginOverlap.RemoveDynamic(this, &ABaseCharacter::OnCoverEndVolumeBeginOverlap);
		CapsuleComponent->OnComponentEndOverlap.RemoveDynamic(this, &ABaseCharacter::OnCoverEndVolumeEndOverlap);
	}
