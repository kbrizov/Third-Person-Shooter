...
void ABasePlayerController::BeginPlay()
{
	...
	if (PlayerCharacter)
	{
		this->OnPlayerDeathHandle = PlayerCharacter->DeathEvent.AddUObject(this, &ABasePlayerController::OnPlayerDeath);
	}
...
void ABasePlayerController::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	...
	if (PlayerCharacter)
	{
		PlayerCharacter->DeathEvent.Remove(this->OnPlayerDeathHandle);
	}
